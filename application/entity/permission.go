...
type Permission struct {
	...
	PermissionMethod   permission.Method `gorm:"column:permission_method;size:128;comment:权限方法"`
	PermissionName     string            `gorm:"column:permission_name;size:512;not null;comment:权限名称"`
	PermissionType     permission.Type   `gorm:"column:permission_type;size:128;not null;comment:权限类型"`
